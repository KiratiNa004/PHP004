...
<body>
    <div class="container mt-5">
        <h1 class="text-center">PHP Check Grade A-E form Scre</h1>
        <hr>
    ...
    <form action="" method="post" class="text-center">
        <div class="from-group">
            <input type="number" name="score" id="score"
                value="<?php echo isset($_POST['score']) ? $_POST['score'] : ''; ?>" class="form-control w-50 mx-auto"
                placeholder="Enter a Score " required>
        </div>
